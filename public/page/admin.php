    ...
    <div>
        <header>
            <ul class="header-nav" id="header">
                <li>
                    <div class="iconmenu"><img class="menu" src="../img/chevron-double-right.svg" alt="menu"></div>
        ...
        <nav>
            ...
            <div class="dropdown" id="dd-gigabot">
                <div class="dropdown-trigger" onclick="toggleDd('dd-gigabot')">
                    ...
                    <a>GigaBot</a>
                    <span class="dd-arrow"><img src="../img/chevron-compact-up.svg" alt="gigabot"></span>
                </div>
                <ul class="dd-menu">
                    <li onclick="dashbord()"><a>Vue d'ensemble</a></li>
                    <li onclick="changelog()"><a>Changelogs</a></li>
                    <li onclick="commandeBot()"><a>Commandes</a></li>
                    <li onclick="report()"><a>Report</a></li>
                    <li onclick="contributeur()"><a>Contributeurs</a></li>
                    <li onclick="projet()"><a>Projets</a></li>
                    <li onclick="compte()"><a>Comptes</a></li>
                    <li onclick="logs()"><a>Logs</a></li>
                </ul>
            </div>

            <div class="dropdown" id="dd-portfolio">
                <div class="dropdown-trigger" onclick="toggleDd('dd-portfolio')">
                    <div class="iconmenu"><img src="../img/images.svg" alt="portfolio"></div>
                    <a>Portfolio</a>
                    <span class="dd-arrow"><img src="../img/chevron-compact-up.svg" alt="gigabot"></span>
                </div>
                <ul class="dd-menu">
    ...
    <nav>
        <ul class="header-nav" id="header-nav-3">
            <button id="theme-toggle-btn" onclick="toggleTheme()">
                <div class="iconmenu" id="dark_mode"><img src="../img/moon-stars.svg" alt="theme"></div>
