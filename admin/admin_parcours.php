...
<head>
    ...
    <title>Gérer les Parcours - Admin</title>
...
<main>
    <h1 class="page-title">Gérer les <em>Parcours</em></h1>
    <p class="page-sub">Ajoutez ou modifiez les différentes étapes du parcours.</p>

    <div class="section-divider"><span>Parcours existants</span></div>

    <section class="card-group" id="parcours-zone">
        <span class="loader"></span>
    </section>

</main>
<script src="../assets/script/admin/renderer/ParcoursRenderer_admin.js"></script>
<script>
